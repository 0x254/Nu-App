...
export declare function fillConfigDefaults(context: BuildContext, userConfig: any, task: TaskInfo): any;
...
export declare function setSourceMapVar(useSourceMap: boolean): void;
export declare function getRootDir(): string;
export declare function getUseSourceMapSetting(): boolean;
