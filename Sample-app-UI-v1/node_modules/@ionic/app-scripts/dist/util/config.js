...
function setSourceMapVar(useSourceMap) {
    setProcessEnvVar(ENV_VAR_SOURCE_MAP, (!!useSourceMap).toString());
}
exports.setSourceMapVar = setSourceMapVar;
function getRootDir() {
    return getProcessEnvVar(ENV_VAR_ROOT_DIR);
}
exports.getRootDir = getRootDir;
function getUseSourceMapSetting() {
    return getProcessEnvVar(ENV_VAR_SOURCE_MAP) === 'true';
}
exports.getUseSourceMapSetting = getUseSourceMapSetting;
var processArgv;
