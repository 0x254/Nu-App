...
var ion_inline_template_1 = require('./plugins/ion-inline-template');
...
function runBundle(context, options, rollupConfig, useCache) {
    ...
    config_1.setSourceMapVar(rollupConfig.sourceMap);
    ...
    if (!options.isProd) {
        ...
        rollupConfig.plugins.unshift(ion_inline_template_1.default(), ion_compiler_1.default());
    }
    if (useCache) {
