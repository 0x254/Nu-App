...
export var Page6 = (function () {
    ...
    Page6 = __decorate([
        Component({
            selector: 'page-page6',template:/*ion-inline-start:"/home/siddharth-shashikar/ionic/ionic-github/NU-app/Sample-app-UI-v2/src/pages/page6/page6.html"*/'<ion-header>\n    <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Apply New Gatepass</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n<button ion-button block outline large (click)="goToOtherlocalPage()" id="localbtn">\n  Local\n</button>\n  <h1 class="ORtext">OR</h1>\n<button ion-button block outline large (click)="goToOtherOutstationPage()" id="outbtn">\n  Outstation\n</button>\n</ion-content>\n'/*ion-inline-end:"/home/siddharth-shashikar/ionic/ionic-github/NU-app/Sample-app-UI-v2/src/pages/page6/page6.html"*/
        }), 
