...
export var Page1 = (function () {
    ...
    Page1 = __decorate([
        Component({
            selector: 'page-page1',template:/*ion-inline-start:"/home/siddharth-shashikar/ionic/ionic-github/NU-app/Nu-App/Sample-app-UI-v3/src/pages/page1/page1.html"*/'<ion-header>\n    <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>TimeTable</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="view responsive">\n <ion-card *ngFor = "let i of lists" (click)="goToOtherPage(i)">\n   <div class="front" [style.backgroundColor] = "i.bgcolor"></div>   \n   <div class="content">{{i.id}} <ion-badge item-right>{{i.nclass}}</ion-badge></div>\n </ion-card>\n</ion-content>\n'/*ion-inline-end:"/home/siddharth-shashikar/ionic/ionic-github/NU-app/Nu-App/Sample-app-UI-v3/src/pages/page1/page1.html"*/
        }), 
