...
export var Page7 = (function () {
    ...
    Page7 = __decorate([
        Component({
            selector: 'page-page7',template:/*ion-inline-start:"/home/siddharth-shashikar/ionic/ionic-github/NU-app/Nu-App/Sample-app-UI-v3/src/pages/page7/page7.html"*/'<ion-header>\n    <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Local Gatepass</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n<button ion-button block outline large id="localbtn" (click)="goToFixedPage()">\n Fixed time\n</button>\n  <h1 id="ORtext">OR</h1>\n<button ion-button block outline large id="outbtn" (click)="goToVariablePage()">\n  Variable time\n</button>\n</ion-content>\n'/*ion-inline-end:"/home/siddharth-shashikar/ionic/ionic-github/NU-app/Nu-App/Sample-app-UI-v3/src/pages/page7/page7.html"*/
        }), 
